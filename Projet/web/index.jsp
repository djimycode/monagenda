...
<h1 style="text-align: right; margin: 0px;">  ${sessionScope.login}   <input   type="submit"  value="logout"  /></span></h1>
                                    </form>  
   </fieldset>
             <div class="container">
			<!-- Codrops top bar -->
			...
			<div class="custom-calendar-wrap custom-calendar-full">
				<div class="custom-header clearfix">
					<h2>Flexible Calendar <span><span>Demo 1</span> | <a href="/Calendario/index2.html">Demo 2</a></span></h2>
